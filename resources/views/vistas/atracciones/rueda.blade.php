    ...
    <div class="container">
        <div class="detail-grid">
            <div class="gallery-section">
                <img src="{{asset('imagenes/rueda1.jpg')}}" alt="Formula Rosca" class="main-image" id="mainImage">
                <div class="thumbnail-gallery">
                    <img src="{{asset('imagenes/rueda1.jpg')}}" alt="Vista 1" class="thumbnail">
                    <img src="{{asset('imagenes/rueda2.jpg')}}" alt="Vista 2" class="thumbnail">
                    <img src="{{asset('imagenes/rueda3.jpg')}}" alt="Vista 3" class="thumbnail">
                    <img src="{{asset('imagenes/rueda4.jpeg')}}" alt="Vista 4" class="thumbnail">
                </div>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="attraction-title-section">
                    ...
                    <div class="rating-section">
                        ...
                        <span class="rating-text">4.8 (2,145 reseñas)</span>
                    </div>
                </div>

                <div class="description">
                    Déjate llevar en Pacific Park por el giro tranquilo de una de las atracciones más clásicas.
                    A medida que asciendes, el paisaje se abre frente a ti con una vista impresionante.
                    En la cima, el tiempo parece detenerse por un instante.
                    Ideal para quienes buscan un momento de calma y asombro.
                    ¡Siente la magia de estar en las alturas y ver todo desde arriba!
                </div>
                <div class="requirements">
                    <h2>Requisitos y Especificaciones</h2>
                    <div class="requirement-grid">
                        <div class="requirement-item"><div class="requirement-icon">📏</div><div class="requirement-text"><h3>Altura Mínima</h3><p>50 cm requeridos</p></div></div>
                        <div class="requirement-item"><div class="requirement-icon ">👨‍👩‍👧</div><div class="requirement-text"><h3>Nivel de Intensidad</h3><p>Baja - Relajado</p></div></div>
                        <div class="requirement-item"><div class="requirement-icon">⏱️</div><div class="requirement-text"><h3>Duración</h3><p> 7 minutos aprox.</p></div></div>
                        <div class="requirement-item"><div class="requirement-icon">🎡</div><div class="requirement-text"><h3>Velocidad Máxima</h3><p>5 km/h</p></div></div>
                    </div>
                </div>
