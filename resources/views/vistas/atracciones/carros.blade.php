    ...
    <div class="container">
        <div class="detail-grid">
            <div class="gallery-section">
                <img src="{{asset('imagenes/carro1.jpg')}}" alt="Formula Rosca" class="main-image" id="mainImage">
            ...
            <div class="info-section">
                ...
                <div class="description">
                    Entra en la pista y siente la emoción de conducir tu propio auto.
                    Acelera, gira y choca suavemente con otros conductores en una batalla llena de risas y reflejos.
                    Cada choque libera una nueva dosis de diversión.
                    Perfecta para competir con amigos o en familia.
                    ¡Demuestra tu habilidad al volante y disfruta del caos controlado!
                </div>
